 ...
 *
 * Test the timing of 5 operations for STL list and vector.
 * Print the counters for the node creation, destruction and copy.
 *
    ...
    throw (string)
{
    ...
    for (int size : SIZES)
    {
        ...
        {
        	cout<<endl;
        	for(Node s:sv.get_vector()){
        		cout<<s<<" ";
        	}
        	cout<<endl;
        	throw string("Vector sort error!");
        }
        ...
        {
        	cout<<endl;
            	for(Node s:sl.get_list()){
            		cout<<s<<" ";

        	cout<<endl;
            	throw string("list sort error!");
            }
        }
    }
